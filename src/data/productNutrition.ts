...
const NUTRITION_BY_SLUG: Record<string, ProductNutritionMeta> = {
  'oyster-mushroom-spawn': {
    specifications: [
      {
        label: 'Note',
        value: 'For mycelial growth — not for human consumption',
      },
      { label: 'Base', value: 'Grain, sawdust, or wood plugs' },
      { label: 'Color', value: 'White to off-white (healthy and pure)' },
      { label: 'Odor', value: 'Earthy, mushroom-like (no foul smell)' },
      ...
      { label: 'Vitamins', value: 'Support metabolic activity' },
      { label: 'Minerals', value: 'Enzymatic reactions in mycelium' },
    ],
    rows: [],
  },
  ...
  'lions-mane-mushroom': {
    basis: 'Nutrition facts per 100g',
    rows: [
  ...
  'dry-shiitake-mushroom': {
    basis: 'Nutritional facts per 100g',
    rows: [
      { label: 'Calories', value: '30' },
      { label: 'Total Fat', value: '0.5g', dailyValue: '0%' },
      { label: 'Sodium', value: '10mg', dailyValue: '0%' },
      { label: 'Potassium', value: '290mg', dailyValue: '8%' },
      { label: 'Total Carbohydrate', value: '5.5g', dailyValue: '2%' },
      { label: 'Dietary Fiber', value: '2.5g', dailyValue: '9%' },
      { label: 'Sugars', value: '—' },
      ...
      { label: 'Iron', value: '0.4 mg', dailyValue: '2%' },
      { label: 'Vitamin D', value: '18 IU', dailyValue: '4%' },
      { label: 'Vitamin B-6', value: '0.169 mg', dailyValue: '15%' },
      { label: 'Magnesium', value: '—' },
      ...
      { label: 'Selenium', value: '8.7 mcg', dailyValue: '8%' },
  ...
  'dry-oyster-mushroom': {
    specifications: [
      ...
      { label: 'Order units', value: '50g, 100g, 250g, 500g' },
      { label: 'Usage', value: 'Reconstitute in warm water' },
      { label: 'Cooking', value: 'Soups, sauces, stir-fry, tea' },
    ],
    basis: 'Nutritional chart per 100g',
    rows: [
      { label: 'Energy', value: '284 kcal' },
      { label: 'Protein', value: '28.5 g' },
      { label: 'Total Fat', value: '2.2 g' },
      { label: 'Dietary Fiber', value: '13.5 g' },
      { label: 'Iron', value: '14.2 mg' },
      { label: 'Vitamin D', value: '5.4 mcg' },
      { label: 'Vitamin B2 (Riboflavin)', value: '3.2 mg' },
      { label: 'Vitamin B3 (Niacin)', value: '12.0 mg' },
      { label: 'Vitamin B5 (Pantothenic Acid)', value: '12.9 mg' },
      { label: 'Potassium', value: '1,500 mg' },
    ],
  },
  'mushroom-powder': {
